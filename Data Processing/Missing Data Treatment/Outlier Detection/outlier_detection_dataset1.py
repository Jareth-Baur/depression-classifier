...
df = pd.read_csv("C:/School Files/Python Model with API Integration/Data Processing/Missing Data Treatment/cleaned_dataset_with_outliers1.csv")
...
df.to_csv('C:/School Files/Python Model with API Integration/Data Processing/Missing Data Treatment/Outlier Detection/dataset1_without_outliers.csv', index=False)
