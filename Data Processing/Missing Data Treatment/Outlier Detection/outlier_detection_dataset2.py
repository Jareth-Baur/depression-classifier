...
df = pd.read_csv("C:/School Files/Python Model with API Integration/Data Processing/Missing Data Treatment/cleaned_dataset_with_outliers2.csv")
...
df.to_csv('C:/School Files/Python Model with API Integration/Data Processing/Missing Data Treatment/Outlier Detection/dataset2_without_outliers.csv', index=False)
